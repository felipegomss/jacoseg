...
export default function Hero() {
  return (
    <div className="relative min-h-screen bg-amber-400 bg-fixed bg-hero-image bg-no-repeat  bg-left-bottom md:bg-right bg-contain flex flex-col px-2 py-16 md:justify-center md:items-center">
